...
import './App.css';
import myImage from './assets/images/iskurlogo.png';
  ...
  return (
    <div className='container'>
      ...
      <div className='part-one box'>
        ...
        <Box component="form" sx={{ mx: 'auto', mb: 4 }}>
        ...
        <Typography variant="subtitle1" sx={{ mb: 1, color: '#00C26D', fontWeight: 'bold', fontSize: '1rem', fontWeight: '500' }}>
        ...
        <div className='footer-content'>
          <Grid container>
            <Grid size={{ xs: 12, md: 2 }} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
              <Box>
                <Typography variant="body2" className="footer-menu-title" data-test="footer-menu-title" sx={{ color: '#878787', letterSpacing: '0.17px' }}>
                  TECHCAREER
                </Typography>

                <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '18px', letterSpacing: '0.025rem' }}>
                  <a
                    href="/about-us"
                    style={{
                      textDecoration: 'none',
            ...
            <Grid size={{ xs: 12, md: 2 }} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
              <Box>
                <Typography variant="body2" className="footer-menu-title" data-test="footer-menu-title">
                  BAŞVUR
                </Typography>
            ...
            <Grid size={{ xs: 12, md: 3 }} sx={{ pl: 5 }}>
              <Box component="a" href="/" data-test="footer-logo">
              ...
              <Box sx={{ mt: 2 }}>
                <Typography variant="subtitle2" data-test="footer-slogan">
                  Türkiye'nin teknoloji kariyeri platformu
                </Typography>
              </Box>
              <Box sx={{ mt: 6, color: '#878787' }}>
                <Typography variant="body2" data-test="footer-menu-title" sx={{ mb: 2.2 }}>
                  SOSYAL MEDYA
                </Typography>
          ...
          <div>
            ...
            <Grid container className="css-2pzf5" sx={{ display: 'flex', justifyContent: 'space-between', color: '#878787' }}>
              ...
              <Grid item md={6} className="css-1y145nx" >
                <Box className="css-jz2god" sx={{ display: 'flex' }}>
                  <a href="https://www.techcareer.net" style={{ color: '#000' }}>
                    <Typography variant="body1" className="css-btujp2" data-test="change-language-item-tr" sx={{ paddingRight: '16px' }} >
                      TR
                    </Typography>
                  </a>
                  <Divider orientation="vertical" flexItem />
                  <a href="https://www.techcareer.net/en">
                    <Typography variant="body1" className="css-12gt6gx" data-test="change-language-item-en" sx={{ padding: '0 16px' }}>
                      EN
                    </Typography>
                  </a>
                </Box>
              ...
              <Grid item md={6} className="css-j4uo9q">
                <Grid container className="css-kmcurt">
                  <Grid item xs={12} md="auto" className="css-ulbauy">
                    <Typography variant="caption" className="css-10cjgr2" data-test="footer-bottom-rights">
                      Tüm hakları saklıdır
                    </Typography>
                  </Grid>
                  <Grid item xs={12} md="auto" className="css-yicr3h" sx={{ pl: 2, pr: 2 }}>
                    <Typography variant="caption" className="css-10cjgr2" data-test="footer-bottom-copyright">
                      © Copyright 2024
                    </Typography>
                  </Grid>
                  <Grid item xs={12} md="auto" className="css-ulbauy">
            ...
            <Grid item className="css-1m5mfel" sx={{ margin: '32px 0' }}>
              <Box className="css-vtpeil" style={{ display: 'flex' }}>
                <Box className="css-6pr531">
                  <img
                    alt="İşkur logo"
                    width={57}
                    height={55}
                ...
                <Box className="css-0">
                  <Typography variant="body1" align="justify" className="css-1gt1b6v">
